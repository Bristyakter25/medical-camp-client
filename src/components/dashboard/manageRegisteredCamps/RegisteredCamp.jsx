...
// display all the camps data of users who have already registered. Ensure that the camp details (Camp name, Camp Fees, Participant Name) are organized and presented in a clear table format. The camp information should be retrieved from the database. Additionally, include fields such as payment status, payment confirmation status, and a cancel button.