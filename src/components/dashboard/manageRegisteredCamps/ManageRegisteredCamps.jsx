...
const ManageRegisteredCamps = () => {
    ...
    return (
        <div>
            <h2 className="text-center w-full mt-16 text-3xl text-[#A294F9] font-bold mb-10">Registered Participants</h2>
                ...
                <table className="table-auto w-full">
                    ...
                    <tbody>
                        {registeredCamps.map((camp) => (
                            <tr key={camp._id}>
                                <td className="border px-4 text-center py-2">{camp.campName}</td>
                                <td className="border px-4 text-center py-2">{camp.campFees}</td>
                                <td className="border px-4 text-center py-2">{camp.participantName}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
