...
const AvailableCampCard = ({ availableCamp }) => {
    const { _id, name, image, date, location, healthcareName,  fees } = availableCamp;
    ...
    return (
        <div
            className="w-[330px] mx-auto my-5 p-5 rounded-2xl bg-white dark:bg-transparent transition-shadow duration-300 hover:shadow-[0_0_25px_5px_rgba(139,92,246,0.5)]"
        >
            ...
            <Link to={`/addCamp/${_id}`}>
                <button className="btn w-full bg-[#C5BAFF] glass hover:bg-purple-500 hover:text-white dark:hover:bg-purple-500 dark:hover:text-white text-violet-500">
                    Details
                </button>
            </Link>
        </div>
